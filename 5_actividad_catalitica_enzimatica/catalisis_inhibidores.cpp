/* Caso de inhibicion en la enzima añadir el vector de inhibidor*/
...
int main() {
    ...
    try {
        ...
        //creacion de vectores crear un vector de vectores
        ...
        //aqui colocar la velocidades de enzima y lo inhibidores
       std::cout << "reaction velocity: " << std::endl;
        ...
        // Calcular los inversos de los vectores - aqui llamar a cada vectores creado en el vector de vectores
        // y calcular sus inversos
        std::vector<double> inv_v1 = inverse(v1);
        std::vector<double> inv_v2 = inverse(v2);

        // Calcular la regresión lineal - usar un ciclo y cambiar la variablae inv_v2 comenzado desde el segun vector del 
        //vector de vectores
